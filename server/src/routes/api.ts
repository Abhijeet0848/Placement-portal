...
import { analyzeResumeUpload, evaluateInterview, startInterview, endInterview, getCareerRoadmap, createCoverLetter, matchJob, parseExamUpload, handleGeneralChat, generateExamQuestionsHandler, careerGuidanceChat } from '../controllers/ai.controller';
...
router.post('/ai/start-interview', authenticateJWT, startInterview);
